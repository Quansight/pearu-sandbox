...
export USE_ENV=${USE_ENV:-functional_algorithms-dev}
if hash conda; then
...
then
    ...
    echo "conda env create  --file=~/git/Quansight/pearu-sandbox/conda-envs/functional_algorithms-dev.yaml -n $USE_ENV"
    exit 1
fi
