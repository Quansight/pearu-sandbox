...
To build, run:
  ...
  python build/build.py --bazel_options=--override_repository=xla=$(realpath ../../openxla/xla) ${JAX_BUILD_OPTIONS}
  pip install -e /home/pearu/git/google/jax/dist  [run once]
